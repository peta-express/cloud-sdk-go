...
func (s *PetaExpressService) UserData(zone string) (*UserDataService, error) {
	properties := &UserDataServiceProperties{
		Zone: &zone,
	}
...
// Documentation URL: https://docs.petaexpress.com/api/userdata/upload_userdata_attachment.html
