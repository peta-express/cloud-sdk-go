...
func (s *PetaExpressService) Misc() (*MiscService, error) {
	properties := &MiscServiceProperties{}

	return &MiscService{Config: s.Config, Properties: properties}, nil
}

// Documentation URL: https://docs.petaexpress.com/product/api/action/misc/get_quota_left.html
...
// Documentation URL: https://docs.petaexpress.com/product/api/action/misc
