...
func (s *PetaExpressService) Image(zone string) (*ImageService, error) {
	properties := &ImageServiceProperties{
		Zone: &zone,
	}
...
// Documentation URL: https://docs.petaexpress.com/api/image/capture_instance.html
...
// Documentation URL: https://docs.petaexpress.com/api/image/delete_images.html
...
// Documentation URL: https://docs.petaexpress.com/api/image/describe-image-users.html
...
// Documentation URL: https://docs.petaexpress.com/api/image/describe_images.html
...
// Documentation URL: https://docs.petaexpress.com/api/image/grant-image-to-users.html
...
// Documentation URL: https://docs.petaexpress.com/api/image/modify_image_attributes.html
...
// Documentation URL: https://docs.petaexpress.com/api/image/revoke-image-from-users.html
