...
@service
Feature: the PetaExpress service
  The PetaExpress service should be available
  As a PetaExpress user
  I can list all zones

  Scenario: need to use PetaExpress service
    When initialize PetaExpress service
    Then the PetaExpress service is initialized
  ...
  # DescribeZones
  Scenario: want to know all PetaExpress zones
    When describe zones
