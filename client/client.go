...
import (
	...
	"github.com/peta-express/cloud-sdk-go/service"
)
...
// PetaExpressClient PetaExpress IaaS Advanced Client
type PetaExpressClient interface {
...
// NewClient return a new PetaExpressClient
func NewClient(config *config.Config, zone string) (PetaExpressClient, error) {
